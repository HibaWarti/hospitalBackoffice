      ...
      <div class="space-y-6 animate-fade-in">
        <div class="grid grid-cols-[1fr_auto] gap-3 items-center">
          ...
          <div class="flex flex-nowrap gap-2 justify-end shrink-0 row-start-1 col-start-2 sm:row-start-2 sm:col-start-2">
            ...
            <button id="add-doctor-btn" class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-primary text-white hover:bg-primary/90 h-9 px-4 py-2 whitespace-nowrap">
