      ...
      <div class="space-y-6 animate-fade-in">
                  ...
                  <tr class="hover:bg-muted transition-colors group">
                    ...
                    <td class="p-4 text-right rtl:text-left">
                      <div class="relative inline-block text-left rtl:text-right">
                        ...
                        <div id="appointment-menu-${app.id}" class="hidden fixed w-48 rounded-md shadow-lg bg-white border border-border ring-1 ring-black ring-opacity-5 focus-visible:outline-none z-50">
                            <div class="py-1">
        ...
        <div class="space-y-2 text-sm text-muted-foreground mt-4 pb-4">
           ...
           <div id="pagination" class="flex items-center justify-center gap-2">
             <button id="prev-page" ${appointmentsState.page === 1 ? 'disabled' : ''} class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors border border-input bg-white hover:bg-accent hover:text-accent-foreground h-8 w-8 disabled:opacity-50">
               <i data-lucide="${prevIcon}" class="w-4 h-4"></i>
             </button>
             ${pageButtons}
             <button id="next-page" ${appointmentsState.page >= totalPages ? 'disabled' : ''} class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors border border-input bg-white hover:bg-accent hover:text-accent-foreground h-8 w-8 disabled:opacity-50">
