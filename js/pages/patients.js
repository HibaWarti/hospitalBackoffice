    ...
    <div class="space-y-6 animate-fade-in">
      <div class="flex items-center justify-between gap-3 min-w-0">
        ...
        <div class="flex flex-nowrap gap-2 justify-end shrink-0">
          ...
          <button id="add-patient-btn" class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-primary text-white hover:bg-primary/90 h-9 px-4 py-2 whitespace-nowrap">
                ...
                <tr class="hover:bg-muted transition-colors group">
                  ...
                  <td class="p-4 ${isRTL ? 'text-left' : 'text-right'}">
                    <div class="relative inline-block text-left">
                      ...
                      <div id="patient-menu-${patient.id}" class="hidden fixed w-48 rounded-md shadow-lg bg-card text-foreground border border-border ring-1 ring-black ring-opacity-5 focus-visible:outline-none z-50">
                        <div class="py-1">
      ...
      <div class="space-y-2 text-sm text-muted-foreground">
        ...
        <div id="pagination" class="flex items-center justify-center gap-2">
          <button id="prev-page" ${patientsState.page === 1 ? 'disabled' : ''} class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground h-8 w-8 disabled:opacity-50">
            <i data-lucide="${prevIcon}" class="w-4 h-4"></i>
          </button>
          ${pageButtons}
          <button id="next-page" ${patientsState.page >= totalPages ? 'disabled' : ''} class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground h-8 w-8 disabled:opacity-50">
      ...
      <div id="patient-details-modal" class="fixed inset-0 z-[1001] hidden items-center justify-center p-4 bg-black/50 backdrop-blur-sm global-overlay">
        <div class="w-full max-w-lg bg-card text-card-foreground border border-border rounded-xl shadow-glow animate-fade-in">
          ...
          <div class="flex justify-end gap-3 p-6 border-t border-border">
            <button id="patient-details-export" class="h-9 px-3 rounded-md border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground text-sm font-medium inline-flex items-center">
